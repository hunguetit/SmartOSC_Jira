      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="treeview">
              <a href="#">
                <i class="fa fa-cubes"></i> <span>Project Manager</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class=""><a href="{{asset('admin/project/create')}}"><i class="fa fa-plus"></i> Create Project</a></li>
                <li><a href="{{asset('admin/project')}}"><i class="fa fa-tasks"></i> Managed Project</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{asset('admin/user')}}"><i class="fa fa-cogs "></i> Manager User</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="">
